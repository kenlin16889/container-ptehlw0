...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ptehlw0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ptehlw0.containers.anotherwebservice.com/
...
```
git clone git@github.com:kenlin16889/container-ptehlw0.git
cd container-ptehlw0
```
...
```
docker attach container-ptehlw0
```
